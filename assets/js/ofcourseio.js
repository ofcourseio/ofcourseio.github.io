...
$(document).ready(function() {
    ...
    $("#sub-url-submit").click(function() {
        ...
        var request_url = "http://localhost/inerd/public/sub_ofurl.php?callback=?";
        // alert(request_url);
        $.getJSON(request_url, { "type": type, "title": title, "url": url }, function(data) {
            if (data.state == "exist") {
                alert("\n\n老大，您提交的资源已经被其他人提交了！\n\n换一个试试！\n\n");
